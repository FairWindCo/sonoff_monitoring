...
class SonoffDevices(models.Model):
    ...
    last_temperature = models.FloatField(null=True, default=None, blank=True, verbose_name='Последняя зарегистрированная температура')
    last_humidity = models.FloatField(null=True, default=None, blank=True, verbose_name='Последняя зарегистрированная влажность')
    ...
    temperature_minimal_warning_value = models.FloatField(null=True, default=None, blank=True, verbose_name='Нижний порог срабатывания предуприждения по температуре')
    temperature_maximal_warning_value = models.FloatField(null=True, default=None, blank=True, verbose_name='Верхний порог срабатывания предуприждения  по температуре')
    temperature_minimal_alarm_value = models.FloatField(null=True, default=None, blank=True, verbose_name='Нижний порог срабатывания тревоги по температуре')
    temperature_maximal_alarm_value = models.FloatField(null=True, default=None, blank=True, verbose_name='Верхний порог срабатывания тревоги по температуре')
    ...
    humidity_minimal_warning_value = models.FloatField(null=True, default=None, blank=True, verbose_name='Нижний порог срабатывания предуприждения по влажности')
    humidity_maximal_warning_value = models.FloatField(null=True, default=None, blank=True, verbose_name='Верхний порог срабатывания предуприждения по влажности')
    humidity_minimal_alarm_value = models.FloatField(null=True, default=None, blank=True, verbose_name='Нижний порог срабатывания тревоги по влажности')
    humidity_maximal_alarm_value = models.FloatField(null=True, default=None, blank=True, verbose_name='Верхний порог срабатывания тревоги по влажности')
...
class SonoffDevicesValues(models.Model):
    ...
    signal = models.FloatField(null=True, default=None, blank=True, verbose_name='Качество WIFI сигнала')
    device = models.ForeignKey(SonoffDevices, on_delete=models.CASCADE, verbose_name='Устройство', related_name='values')
